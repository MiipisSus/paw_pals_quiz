        ...
        <div className="fixed inset-0 center bg-black/50 z-30">
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl">
            ...
            <div className="flex gap-3 justify-end">
              <button
                className="px-6 py-2 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 btn-animate"
                onClick={handleCancelExit}
              >
                {t("game.cancel", "取消")}
              </button>
              <button
                className="px-6 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 btn-animate"
      ...
      <div className="flex w-[clamp(60rem,70%,75rem)] h-7/10 overflow-hidden bg-white rounded-4xl shadow-2xl">
        ...
        <div className="center flex-col w-1/2">
            ...
            {currentChoices.length > 0
              ? currentChoices.map((choice, index) => (
                  <button
                    ...
                    className={`text-white font-semibold p-3 rounded-lg shadow-sm btn-animate ${
                      isAnswerCorrect !== null
                        ...
                        : "bg-darker-primary cursor-pointer hover:brightness-110"
                    }`}
                    onClick={() =>
          ...
          >
            ...
            {isGameOver ? (
              <button
                className="center gap-2 px-4 py-1 text-sm font-semibold bg-darker-accent text-white rounded-2xl btn-animate"
              ...
              <button
                className="center gap-2 px-4 py-1 text-sm font-semibold bg-brown text-white rounded-2xl btn-animate"
                onClick={() => handleQuestionFetch()}
              >
                {t("game.nextRound")}
                <ArrowRight className="size-4 font-semibold icon-animate group-hover:translate-x-1" />
              </button>
            )}
          </div>
        </div>
