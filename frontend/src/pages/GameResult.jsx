  ...
  return (
    <div className="center w-screen h-screen">
      <div className="relative flex flex-col w-8/10 h-9/10 bg-gray-100  rounded-4xl shadow-2xl overflow-hidden">
        ...
        <div className="center gap-10 mt-auto px-10 w-full h-1/10 bg-white">
          <button
            className="center flex-1 gap-2 py-3 font-semibold text-brown bg-white border-2 border-darker-primary rounded-2xl"
            onClick={() => navigate("/")}
          >
            <House className="inline-block size-6" /> HOME
          </button>
          <button
            className="center flex-1 gap-2 py-3 font-semibold text-white bg-darker-primary border-2 border-darker-primary rounded-2xl"
